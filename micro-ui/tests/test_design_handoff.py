...
class MicroUiDesignHandoffStaticTests(unittest.TestCase):
    ...
    def test_css_contains_handoff_components(self) -> None:
        ...
        self.assertIn('.session-stop-button', css)
    ...
    def test_js_contains_json_highlighting_and_question_hydration(self) -> None:
        ...
        self.assertIn('function stopSession', js)
        self.assertIn('function isActiveSessionStatus', js)
        self.assertIn('/api/sessions/${encodeURIComponent(session.session_id)}/stop', js)
