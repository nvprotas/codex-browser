...
| `docs/self-evolving-buyer-report-2026-05-02.md` | Исследовательский отчет о замыкании self-improving/self-evolving loop для `buyer`. | SotA-подходы на 2026-05-02, текущие пробелы, целевая архитектура candidate lifecycle, конкретные точки изменений. |
